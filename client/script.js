...
sayHelloButton.addEventListener('mouseover', changeBackColor)
...
function changeBackColorOg(e){
    sayHelloButton.style.backgroundColor = "";
    sayHelloButton.style.color = "";
}

sayHelloButton.addEventListener('mouseout', changeBackColorOg)
...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/string').then(response => {
    ...
    let repeatMyParamBtn = document.querySelector('#repeat-button');
